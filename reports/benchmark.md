...
- Average retrieval latency: **1024.2 ms**
- Average token reduction vs full source context: **14.2%**

| Case | Layer | Pass | Latency ms | Retrieved tokens | Token reduction | Missing / Error |
| --- | --- | --- | ---: | ---: | ---: | --- |
| E01 | short_term | PASS | 0.1 | 133 | 0.0% |  |
| E06 | semantic | PASS | 426.8 | 148 | 67.8% |  |
| E09 | long_term | PASS | 1731.2 | 733 | 0.0% |  |
| E10 | short_term | PASS | 0.9 | 195 | 0.0% |  |
| E02 | long_term | PASS | 1839.4 | 1411 | 0.0% |  |
| E03 | long_term | PASS | 1806.0 | 1410 | 0.0% |  |
| E04 | episodic | PASS | 451.7 | 234 | 0.0% |  |
| E05 | episodic | PASS | 525.0 | 268 | 0.0% |  |
| E07 | mixed | PASS | 1945.8 | 485 | 14.2% |  |
| E11 | semantic | PASS | 482.7 | 146 | 74.2% |  |
| E08 | long_term | PASS | 2057.0 | 1410 | 0.0% |  |
...
`<USER_SUMMARY> The user is studying async/await, often confusing coroutines with Tasks. Their personal project is ORCHID-27, for which they prefer Python. The company project BLUEBIRD-42 requires TypeScript with NestJS, and Python is not to be used for this project. They have a benchmark report, open loop LAB-REPORT-1600, due by Saturday at 16:00. The user is debugging async HTTP, investigating connection pool, client lifecycle, and concurrency. The primary issue identified in the ASYNC-FIX-20 incident is connection churn, not timeout threshold. Increasing the timeout to 60 seconds was ineffective. Reusing an aiohttp ClientSession and setting concurrency to 20 effectively resolves connection`
...
`<LONG_TERM> <USER_SUMMARY> The user is studying async/await, often confusing coroutines with Tasks. Their personal project is ORCHID-27, for which they prefer Python. The company project BLUEBIRD-42 requires TypeScript with NestJS, and Python is not to be used for this project. They have a benchmark report, open loop LAB-REPORT-1600, due by Saturday at 16:00. The user is debugging async HTTP, investigating connection pool, client lifecycle, and concurrency. The primary issue identified in the ASYNC-FIX-20 incident is connection churn, not timeout threshold. Increasing the timeout to 60 seconds was ineffective. Reusing an aiohttp ClientSession and setting concurrency to 20 effectively resolve`
